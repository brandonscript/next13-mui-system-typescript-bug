// generated via: https://github.com/brandonscript/mui-react-icons-generator
...
const SvgAircraftPrivateJetMd = (
  props: SvgIconProps & { sx?: any }
) => {
  const { sx, ...other } = props;

  const fontSize =
    other.fontSize || (sx as any)?.fontSize || other?.style?.fontSize || undefined;
